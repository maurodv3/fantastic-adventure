...
public class MinesweeperController {
    ...
    @Operation(summary = "Starts a new minesweeper game.", security = { @SecurityRequirement(name = "bearer-key") })
    ...
    @Operation(summary = "Executes an click operation on an existing minesweeper game board.", security = { @SecurityRequirement(name = "bearer-key") })
